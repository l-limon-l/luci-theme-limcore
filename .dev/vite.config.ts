...
function createLocalServePlugin(): Plugin {
  const resourceConfig: ResourceConfig = {
    css: {
      routes: {
        "/luci-static/limcore/main.css": "/src/media/main.css",
      },
      shouldRewrite: true,
    ...
    js: {
      routes: {
        "/luci-static/resources/view/limcore/sysauth.js":
          "src/resource/view/limcore/sysauth.js",
        "/luci-static/resources/menu-limcore.js": "src/resource/menu-limcore.js",
      },
      shouldRewrite: false,
  ...
  return {
    ...
    configureServer(server) {
      server.middlewares.use(async (req, res, next) => {
        ...
        if (pathname.startsWith("/luci-static/limcore/")) {
          const subPath = pathname.replace("/luci-static/limcore/", "");
          ...
          if (mimeTypes[ext]) {
            try {
              const filePath = resolve(CURRENT_DIR, "public/limcore", subPath);
  ...
  return {
    ...
    build: {
      ...
      rollupOptions: {
        ...
        output: {
          assetFileNames: "limcore/[name].[ext]",
        },
      },
    },
